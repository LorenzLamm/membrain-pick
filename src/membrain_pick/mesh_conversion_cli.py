...
def convert_single_file(
    ...
    crop_box_flag: bool = Option(  # noqa: B008
        False,
        help="Should the mesh be cropped to the bounding box of the segmentation?",
    ),
...
def convert_folder_structure(
    ...
    tomo_folder: str = Option(  # noqa: B008
        ...,
        help="Path to the folder containing the tomograms to be projected.",
        **PKWARGS,
    ),
    out_folder: str = Option(  # noqa: B008
        "./mesh_data",
...
def predict(
    ...
    C_width: int = Option(64, help="Width of the convolution."),  # noqa: B008
    conv_width: int = Option(16, help="Width of the convolution."),  # noqa: B008
    k_eig: int = Option(128, help="Number of eigenvectors."),  # noqa: B008
    mean_shift_output: bool = Option(  # noqa: B008
        False, help="Should the output be mean shifted?"
